...
from .views import (
    ...
    student_report,
    student_report_pdf,
    teacher_competency_gradebook_export_excel,
...
urlpatterns = [
    ...
    path('assignments/<int:assignment_id>/competencies/', manage_competencies, name='manage_competencies'),
    ...
    path('teacher/competencies/export-excel/', teacher_competency_gradebook_export_excel, name='teacher_competency_gradebook_export_excel'),
